...
void NPRACHDetector(UINT16 ui16IterTestcase)
{
  if (stTxParams.ui8PreambleFormat == 0)
    {
      stOut = NPRACHDetectorPrm0(ui16IterTestcase, 0);
      ...
      for (ui32Iter = 0; ui32Iter < NUM_SC; ui32Iter++)
      {
          ...
          if (DYNDET == 0)
          {
            if ( (stOut.aui8UAD[ui32Iter] >= stTxParams.ui8UADTHCVA3 && CVA == 3 ) ||
               (stOut.aui8UAD[ui32Iter] >= stTxParams.ui8UADTHCVA2 && CVA == 2 ) ||
               (stOut.aui8UAD[ui32Iter] >= stTxParams.ui8UADTHCVA1 && CVA == 1 ))
            {
  ...
  else if (stTxParams.ui8PreambleFormat == 1)
    {
      ...
      */
      ...
      Output_t stOut1     = NPRACHDetectorPrm0(ui16IterTestcase, 0);

      Output_t stOut2     = NPRACHDetectorPrm0(ui16IterTestcase, 1);
