...
void NPRACHConfig(UINT8 ui8CvArea)
{
  ...
  stTxParams.ui8UADTHCVA2 = 8; // Initially it was 12, changed it to 8 after analyzing UAD values for CVA 2; PRM 1 case
  stTxParams.ui8UADTHCVA3 = 4; // Initially it was 10, changed it to 4 after analyzing UAD values for CVA 3; PRM 0 case
  ...
  stTxParams.ui8PreambleFormat = PRM; // Preamble Format
