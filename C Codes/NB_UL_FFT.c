...
* Exception             : NONE
******************************************************************************/
void NBIOT_UL_FFT(CPLX16 *pcplx16Inp,CPLX16 *pcplx16Output, UINT16 ui16Fftsize,UINT16 ui16Inlen)
{
    ...
    memcpy(acplx16TempFftInputBuffer,pcplx16Inp,ui16Inlen*sizeof(CPLX16));
